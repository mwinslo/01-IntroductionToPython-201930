...
bleu = rg.SimpleTurtle()
bleu.pen = rg.Pen('blue' , 10)

bleu.go_to(rg.Point(bleu.x_cor() , bleu.y_cor() + 200 )) # There was no instruction to rotate :^)
bleu.pen_up()
bleu.go_to(rg.Point(100 , -40))
bleu.pen_down()
bleu.pen = rg.Pen('green' , 10)
bleu.go_to(rg.Point(bleu.x_cor() , bleu.y_cor() - 150 ))
